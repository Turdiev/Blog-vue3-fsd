...
const isMobile = computed(() => document.body.clientWidth <= 400)
...
<template>
  ...
  >
    <div class="pagination__pages">
      <button
        class="pagination__button _arrow-btn pagination__button--arrow-prev pseudo-arrow"
        type="button"
      ...
      <button
        class="pagination__button _arrow-btn pseudo-arrow"
        type="button"
